...
int main(int argc, char *argv[])
{
    ...
    if (qgetenv("12PROSCRCPY_ADB_PATH").isEmpty()) {
        qputenv("12PROSCRCPY_ADB_PATH", "../../../12ProScrcpy/12ProScrcpyCore/src/third_party/adb/linux/adb");
    }
    ...
    */
    ...
    qInfo() << QObject::tr("This software is completely open source and free. Use it at your own risk. You can download it at the "
            "following address:");
    qInfo() << QString("12ProScrcpy %1 <https://github.com/barry-ran/QtScrcpy>").arg(QCoreApplication::applicationVersion());
